...
public class ClassFile implements ClassInfo {
     ...
     * stream.
     *
     * @param file   The file in which the class resides.
     * @param loader The class info loader which loaded the class.
     * @param in     The data stream containing the class.
     * @throws ClassFormatError When the class could not be parsed.
     */
     ...
     * methods.
     *
     * @param modifiers        The modifiers describing the newly-created class
     * @param classIndex       The index of the type of the newly-created class in its
     *                         constant pool
     * @param superClassIndex  The index of the type of the newly-created class's superclass
     *                         in its constant pool
     * @param interfaceIndexes The indexes of the types of the interfaces that the
     *                         newly-created class implements
     * @param constants        The constant pool for the newly created class (a list of
     *                         {@link Constant}s).
     */
     ...
     *
     * @param index The index of the name of the class.
     */
     ...
     * superclass.
     *
     * @param index The index of the name of the superclass.
     */
     ...
     * interfaces.
     *
     * @param indices The indices of the names of the interfaces.
     */
     ...
     * the Modifiers class.
     *
     * @param modifiers A bit vector of modifier flags for the class.
     * @see Modifiers
     */
    ...
    /**
     *
     * @return the byte array of the committed class.
     */
    public byte[] commitToBytes() {
     ...
     *
     * @param nameIndex Index in the constant pool of the name of the method to be
     *                  deleted
     * @param typeIndex Index in the constant pool of the type of the method to be
     *                  deleted
